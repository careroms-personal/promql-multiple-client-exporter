...
def to_csv(query_results: QueryResult, output: OutputExportEntry, pipeline_file_path: str):
  ...
  file_path = output_dir / f"{query_results.pipeline_config_id}.csv"

  first_row = query_results.rows[0]
